      ...
      <div className="py-20 xl:pb-[150px] xl:pt-[130px]">
        ...
        <div className="global-container">
          ...
          <div className="jos mb-10 max-w-[480px] md:mb-16 lg:mb-20 lg:max-w-2xl xl:max-w-[800px]">
            <h2 className="font-spaceGrotesk text-4xl font-medium leading-[1.06] -tracking-[2px] text-white sm:text-[44px] lg:text-[56px] xl:text-[70px]">Defenses to stay ahead of all evolving all threats</h2>
          </div>
          {/* Section Content Block */}
