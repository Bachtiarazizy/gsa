      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className="grid items-center gap-12 lg:grid-cols-2 lg:gap-20">
          ...
          <div className="group relative order-2 lg:order-1">
            ...
            {/* Decorative elements */}
            <div className="absolute -right-6 -top-6 -z-10 h-24 w-24 rounded-full bg-green-500/10 dark:bg-green-500/5 blur-2xl" />
            <div className="absolute -bottom-6 -left-6 -z-10 h-24 w-24 rounded-full bg-blue-500/10 dark:bg-blue-500/5 blur-2xl" />
          </div>

          {/* Content Container */}
          <div className="order-1 space-y-8 lg:order-2">
            <div>
              <h2 className="font-heading mb-6 text-4xl font-bold tracking-tight text-foreground sm:text-5xl lg:text-6xl">
                Transform Your Career with
                <span className="relative mx-2 block">
                  <span className="relative z-10 bg-gradient-to-r from-green-600 to-blue-600 bg-clip-text text-transparent dark:from-green-400 dark:to-blue-400">Expert Training</span>
            ...
            <Link
              ...
              className="group inline-flex items-center gap-2 rounded-full bg-gradient-to-r from-green-600 to-blue-600 px-8 py-4 text-lg font-semibold text-white shadow-lg transition-all duration-300 hover:shadow-xl dark:from-green-500 dark:to-blue-500 dark:shadow-lg/20 dark:hover:shadow-xl/30"
            >
              Explore Our Courses
