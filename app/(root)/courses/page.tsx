...
import { getCoursePage } from "@/lib/actions/course";
...
const SearchContent = async ({ searchParams }: { searchParams: { title?: string; categoryId?: string } }) => {
  ...
  const courses = await getCoursePage({
