...
import { Bold, Italic, Strikethrough, List, ListOrdered, Heading1, Heading2, Heading3, Link as LinkIcon, Image as ImageIcon, AlignLeft, AlignCenter, AlignRight, Undo, Redo } from "lucide-react";
...
export const Editor = ({ onChange, value, placeholder = "Start typing here..." }: EditorProps) => {
  ...
  const editor = useEditor({
    ...
    editorProps: {
      attributes: {
        class: "prose prose-sm sm:prose-base focus:outline-none max-w-none p-4 min-h-[200px] editor-content",
      },
    },
  });
